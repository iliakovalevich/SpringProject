...
//            String sql = "INSERT INTO coursedb.order (title, price) Values (?, ?)";
...
//        try (Connection connection = dataBaseConnection()) {
//            String sql = "INSERT INTO coursedb.ready (id,title, price) Values (?,?, ?)";
//            PreparedStatement preparedStatement = connection.prepareStatement(sql);
...
//        try (Connection connection = dataBaseConnection()) {
//            String sql = "SELECT * FROM coursedb.menu WHERE id=?";
...
//        try {
//            String url = "jdbc:mysql://localhost:3306/coursedb?serverTimezone=Europe/Moscow&useSSL=false";
